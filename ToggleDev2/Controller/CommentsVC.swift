...
class CommentsVC: UIViewController {
    ...
    @IBAction func postButtonPressed(_ sender: Any) {
        ...
        let comment = Comment(content: commentTextField.text, owner: self.user!, post: self.post)
        currentComments.append(comment)
        // TODO: put this comment in the cloud
        let dataManager = DataManager()
        
        dataManager.createUser(user: self.user!)
        dataManager.createComment(comment:comment, post: self.post!, comments: self.currentComments)
